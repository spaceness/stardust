							...
							<TooltipTrigger asChild>
								<DialogTrigger asChild>
									<Button variant="outline" size="icon">
										<Info aria-label="Info" className="h-[1.2rem] w-[1.2rem] transition-all" />
									</Button>
								</DialogTrigger>
							</TooltipTrigger>
							<TooltipContent>About Stardust</TooltipContent>
						</Tooltip>
					</TooltipProvider>
					<DialogContent>
						<DialogHeader>
						...
						<DialogDescription className="flex flex-col items-start justify-start gap-2 text-foreground">
							...
							<section>
								This version of Stardust was built on {new Date(Number(process.env.BUILD_DATE)).toLocaleString()} on
								commit{" "}
								<a
									href={`https://github.com/z1g-project/Ephemeral/commit/${process.env.GIT_COMMIT}`}
									className="inline font-medium text-primary underline-offset-4 hover:underline"
								>
							...
							<DialogFooter>
								<TooltipProvider>
									<Tooltip>
										<TooltipTrigger asChild>
											<Button asChild variant="outline" size="icon">
												<Link href="https://github.com/spaceness/stardust">
													<svg
									...
									<Tooltip>
										<TooltipTrigger asChild>
											<Button variant="outline" size="icon" asChild>
												<Link href="https://stardust.spaceness.one/docs">
									...
									<Tooltip>
										<TooltipTrigger asChild>
											<Button variant="outline" size="icon" asChild>
												<Link href="https://stardust.spaceness.one/">
