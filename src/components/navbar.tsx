						...
						<DialogFooter>
							<TooltipProvider>
								<Tooltip>
									<TooltipTrigger asChild>
										<Button asChild variant="outline" size="icon">
											<Link href="https://github.com/spaceness/stardust" target="_blank" rel="noreferrer nopener">
												<svg
								...
								<Tooltip>
									<TooltipTrigger asChild>
										<Button variant="outline" size="icon" asChild>
											<Link href="https://stardust.spaceness.one/docs" target="_blank" rel="noreferrer nopener">
								...
								<Tooltip>
									<TooltipTrigger asChild>
										<Button variant="outline" size="icon" asChild>
											<Link href="https://spaceness.one/" target="_blank" rel="noreferrer nopener">
