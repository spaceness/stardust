					...
					>
						{images.map((image, key) => (
							...
							>
								<Card
									key={key}
									className="bg-foreground/10 hover:bg-muted m-2 flex h-24 w-24 flex-col items-center justify-start gap-2 p-2 backdrop-blur-md duration-150 md:w-56 md:flex-row"
								>
									<Image
										priority={true}
										src={image.icon}
